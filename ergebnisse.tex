...
\begin{tikzpicture}[trim axis left, trim axis right]
  \begin{axis}[
    ...
    \addplot+[color=red,mark=x,
    		boxplot prepared={
      		lower whisker=0.0133529306,
      		lower quartile=0.1985780895,
      		median=0.2542533912,
      		upper quartile=0.3528155387,
      		upper whisker=0.7293745875
    		},
    ] coordinates {};
    %table[row sep=\\,y index=0] {0.0\\}; %Ausreisser
    \addplot+[color=Green,mark=x,
    		boxplot prepared={
      		lower whisker=0.0024784356,
      		lower quartile=0.1018498093,
      		median=0.2864509821,
      		upper quartile=0.617288053,
      		upper whisker=0.6959207356
		},
    ] coordinates {};
    %table[row sep=\\,y index=0] {0.0\\}; %Ausreisser
    \addplot+[color=blue,mark=x,
    		boxplot prepared={
      		lower whisker=0.0467300415,
      		lower quartile=0.6718873977,
      		median=1.1176168919,
      		upper quartile=1.9123554229,
      		upper whisker=3.0851304531
		},
    ] coordinates {};
    %table[row sep=\\,y index=0] {0.0\\}; %Ausreisser
  \end{axis}
