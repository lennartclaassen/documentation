...
\newcommand{\matx}[1]{\left[ \begin{array}{ccc} 1 & 0 & 0 \\ 0 & \cos{#1} & -\sin{#1} \\ 0 & \sin{#1} & \cos{#1} \end{array} \right]}
\newcommand{\maty}[1]{\left[ \begin{array}{ccc} \cos{#1} & 0 & \sin{#1} \\ 0 & 1 & 0 \\ -\sin{#1} & 0 & \cos{#1} \end{array} \right]}
\newcommand{\matz}[1]{\left[ \begin{array}{ccc} \cos{#1} & -\sin{#1} & 0 \\ \sin{#1} & \cos{#1} & 0 \\ 0 & 0 & 1 \end{array} \right]}
