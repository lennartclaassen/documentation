...
\nomenclature[l]{${^{a}\vec{T}_{b}}$}{Homogene Transformation vom $\ind{(KS)}_a$ ins $\ind{(KS)}_b$}
%\nomenclature[l]{$\ks{j},\ks{k}$}{Variable Koordinatensysteme}
\nomenclature[k]{$\ks{0}$}{Globales Koordinatensystem}
...
\nomenclature[l]{${^{a}\vec{R}_{b}}$}{Rotationsmatrix vom vom $\ind{(KS)}_a$ ins $\ind{(KS)}_b$}
