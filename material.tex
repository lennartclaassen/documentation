...
\red[Als Projektor wurde ein pico Laser Projektor verwendet, welcher sich neben der geringen Grö"se dadurch auszeichnet, dass als Lichtquelle ein Laser zum Einsatz kommt. Damit ist es nicht erforderlich manuelle Fokuseinstellungen vorzunehmen, um die Schärfe des projizierten Bildes an die Projektionsfläche anzupassen. Genauere Spezifikationen des Projektors finden sich in Anhang \ref{app:projector}.]
