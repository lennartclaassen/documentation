...
Einleitender Absatz: Kapitel umfasst den Aufbau des \kps{s} und die verwendete Software, sowie die entwickelte Programmstruktur\\
]
\section{Hardware}
...
\red[Punktlinien der Linsen mit größerem Abstand!\\]
...
\begin{figure}[ht]
	\begin{center}
		\includegraphics[scale=1.0]{chessboard_small}
...
\begin{figure}[ht]
	\begin{center}
		\includegraphics[scale=1.0]{chessboard_projected_small}
